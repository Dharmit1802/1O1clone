  ...
  return (
    <div className='bg-slate-900 w-full'>
        <div className='w-3/4 mx-auto py-5'>
            <h1 className='flex justify-center text-5xl my-8 text-white font-bold w-full'>Get A Seamless Experience On Our App</h1>
            <div className='w-full bg-slate-800 rounded-2xl m-2 flex justify-between flex-row'>
                <div className='w-2/3 px-3'>

                <img className='max-w-[146%]' src="https://s3.ap-south-1.amazonaws.com/data.com.live101.in/images/landing_page/app-experience.png" alt='footer'/>
                </div>
                <div className='flex flex-col justify-between items-end p-6 w-1/3'>
                    <h1 className='mx-auto text-xl text-white'>Download our app</h1>
                    <div className='bg-white rounded-2xl w-full h-[85%] p-3 flex flex-col justify-center gap-3'>
                        <a><img src='https://s3.ap-south-1.amazonaws.com/data.com.live101.in/images/landing_page/playstore-icon.png'/></a>
                        <a><img src='https://s3.ap-south-1.amazonaws.com/data.com.live101.in/images/landing_page/appstore-icon.png'/></a>
                    </div>
                </div>
            </div>
